...
public abstract class BlackJackLikePlayer implements Dealer, OrdinaryPlayer{
    ...
    public int bet(int lowerBound, int upperBound){
        int specificMoney= Utility.getIntegerFromUser("Please Player "+serialNumber+" input the bet between ",lowerBound,upperBound);
        return bet(specificMoney);
    }

    @Override
    public int bet(int specificMoney){
        Utility.promptUser("Player " +serialNumber+" bet "+specificMoney);
    ...
    public void setAmountOfMoneyByUser(){
        amountOfMoney= Utility.getIntegerFromUser("Hello, Player "+serialNumber+", please input your amount of your money, an integer between:",100000,10000000);
    }
    ...
    public void printHandsOfPokerCards(){
        ...
        stringBuilder.append(Utility.ANSI_PURPLE);
        ...
        stringBuilder.append(Utility.ANSI_RESET);
